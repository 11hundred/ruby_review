...
# def weather(city, temp)
#   # city = "Chicago"
#   # temp = -50
#   puts "In #{city} it's #{temp} degrees"
# end
...
# chicago_food = [ "Hot Doug's", "Portillo's", "Kuma's"  ]
...
# bob = { "zip" => 60606, "street" => "155 N Wacker", "city" => "Chicago"  }
...
# messages = ["ruin Halloween", "are the worst", "are basically inedible"]

# worst_candy.each do |candy|
#   puts "#{candy} #{messages.sample}"
# end
...
#   def happiness
#     puts "Happiness is now #{@happiness}"
#   end
